...
Block.prototype = Object.defineProperties({}, {
  ...
  subinspect: D._CW(function subinspect(){ return '<'+this.reify()+'>' }),
...
Object.keys(types).forEach(function(type){
  ...
  function Numeric(buffer, byteOffset, val){
    if (!Block.isBlock(this)) {
      return typeof buffer === 'number' ? castToType(type, buffer) : new Numeric(buffer, byteOffset, val);
    }
  ...
  var interface = eval('(function '+type+'(){ return Numeric.apply(this, arguments) })');
  ...
  interface.prototype = Numeric.prototype = Object.create(Block.prototype, {
