...
function StructType(fields){
  ...
  var ctor = function StructConstructor(vals){
    return StructAllocate(ctor, this, vals);
  }
  ...
  function StructAllocate(structctor, target, vals){
    Object.defineProperties(target, {
      _Class:    D.___('Data'),
      _Value:    D.___(new StructBlock(structctor, vals || {})),
      _DataType: D.___(structctor._DataType),
    });
    return target;
  }
