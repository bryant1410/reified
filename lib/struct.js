...
var initStructT  = require('./genesis').initType.bind(StructType);
...
function StructType(name, fields){
  ...
  var StructT = initStructT(name, bytes, function StructT(buffer, offset, values){
  ...
  Object.defineProperties(StructT, {
