...
function StructType(fields){
  ...
  var ctor = function StructConstructor(vals, buffer){
    return StructAllocate(Object.create(ctor.prototype), vals, buffer);
  }
  ...
  function StructAllocate(target, values, buffer){
    return Object.defineProperties(target, {
      _Value:    D._C_(new StructBlock(ctor, values || {}, buffer)),
      _DataType: D._C_(ctor._DataType),
      constructor: D.EC_(ctor)
    });
  }
