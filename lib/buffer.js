...
!function(global, exporter){
  ...
  if (global.DataView) {
    ...
    mapMethods(function(to, from, usesEndian){
      if (usesEndian) {
        DataBuffer.prototype['read'+to]  = function(offset){ return this.view['get'+to].call(this.view, offset || 0, this.endianness === 'BE') }
        DataBuffer.prototype['write'+to] = function(value, offset){ return this.view['set'+to].call(this.view, offset || 0, value || 0, this.endianness === 'BE') }
      } else {
