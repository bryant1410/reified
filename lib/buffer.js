1 && function(global, exporter){
  ...
  if (global.Buffer) {
    ...
    BuffBuffer.prototype = copy(Object.create(Buffer.prototype), {
      ...
      copy: buff.copy,
      toString: toString
      //inspect: null//function(){ return '<View'+buff.inspect.call(this).slice(1) }
    });
  ...
  if (global.DataView) {
    ...
    DataBuffer.prototype = copy(Object.create(DataView.prototype), {
      ...
      toString: toString
      //inspect: function(){ return '<Data'+buff.inspect.call(this.view.buffer).slice(1) }
    });
